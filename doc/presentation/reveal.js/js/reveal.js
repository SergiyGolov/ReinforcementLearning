...
Reveal.initialize({symbolperslideprogress: {
	...
	symbolColor: "#516e80", // Colors like red/#ff0000/rgb(255, 0, 0)

	// Specifies the color for the symbol of the current active slide.
	// Default is the link color of your selected theme
	// Color names like red, Hex codes like #ff0000 and RGB values like rgb(255, 0, 0) are working
	symbolActiveColor: "#9ec189",
},
dependencies: [
	{ src: 'reveal.js/plugin/symbol-per-slide-progress/symbol-per-slide-progress.js', async: true }
]});
